...
function prerenderingLectures(){[].forEach.call(cacheDom.lectures,(lecture,i)=>{[].forEach.call(arguments,renderFn=>{if(typeof renderFn!=='function')throw new Error('One of the passed parameters in the pre-rendering function is not a function');renderFn(lecture,i)})})}
